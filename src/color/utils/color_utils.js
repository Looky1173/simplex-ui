 ...
 */
export const alphaFromInt = (argb) => {
 ...
 */
export const greenFromInt = (argb) => {
 ...
 */
export const lstarFromInt = (argb) => {
 ...
 */
export const intFromXyzComponents = (x, y, z) => {
    x = x / 100.0;
    y = y / 100.0;
    z = z / 100.0;
 ...
 */
export const intFromLstar = (lstar) => {
