...
export class ViewingConditions {
     ...
     */
    static make(whitePoint = utils.WHITE_POINT_D65, adaptingLuminance = ((200.0 / Math.PI) * utils.yFromLstar(50.0)) / 100.0, backgroundLstar = 50.0, surround = 2.0, discountingIlluminant = false) {
