...
export class HCT {
     ...
     */
    set hue(newHue) {
        this.setInternalState(getInt(math.sanitizeDegrees(newHue), this.internalChroma, this.internalTone));
    }
...
function getInt(hue, chroma, tone) {
    return getIntInViewingConditions(math.sanitizeDegrees(hue), chroma, math.clamp(0.0, 100.0, tone), ViewingConditions.DEFAULT);
}
